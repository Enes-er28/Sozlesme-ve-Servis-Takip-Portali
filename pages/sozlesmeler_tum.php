...
$hareketler = $admin->getAboneHizmetler(); // AdminClass'ta tüm kayıtları döndüren fonksiyon olmalı
...
<div class="content-wrapper">
  <section class="content-header"><h1>Tüm Sözleşmeler</h1></section>
...
<td>
  <div style="display:flex; gap:5px; align-items:center;">
    ...
    <!-- Silme butonu -->
    <form method="POST" onsubmit="return confirm('Bu kaydı ve bağlı tüm hareketleri silmek üzeresiniz. Silmek istiyor musunuz?');" style="margin:0;">
