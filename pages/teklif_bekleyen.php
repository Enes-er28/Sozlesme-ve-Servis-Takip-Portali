...
$hareketler = $admin->getBekleyenTeklifler(); // AdminClass'ta tüm kayıtları döndüren fonksiyon olmalı
...
<div class="content-wrapper">
  <section class="content-header"><h1>Bekleyen Teklifler</h1></section>
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              >
                  ...
                  <td><?= $row['baslangic'] ? date('d/m/Y', strtotime($row['baslangic'])) : '' ?></td>
...
>Detay</button>
            ...
            <button class="btn btn-success btn-sm btn-kabul" data-id="<?= $row['teklif_id'] ?>">Kabul</button>
            <button class="btn btn-danger btn-sm btn-ret" data-id="<?= $row['teklif_id'] ?>">Ret</button>
            <button class="btn btn-warning btn-sm btn-aktar" data-id="<?= $row['teklif_id'] ?>">Aktar</button>
