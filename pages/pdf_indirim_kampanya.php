...
if($hasFatura) $html .= '<th width="55" align="center">Kam.İnd.</th>';
$html .= '<th width="65" align="center">ErBilg.İnd.</th>'; // Yeni sütun eklendi
...
foreach($detay['hareketler'] as $h) {
    ...
    $indirim_er = intval($h['indirim_er'] ?? 0);
    ...
    if($indirim_er > 0){
        $fiyatIndirimli *= (1 - $indirim_er / 100);
    }
    ...
    $html .= '<tr>
        ...
        <td width="55" align="center" valign="middle">%'.number_format($indirim, 0, ',', '.').' </td>
        <td width="65" align="center" valign="middle">%'.number_format($indirim_er, 0, ',', '.').' </td>
        <td width="70" align="right">'.number_format($tutar, 2, ',', '.').' </td></tr>';
}
...
$htmlAlt .= '<tr style="background-color:#ffffff; font-weight:bold;">
    <td width="140" align="right">Brüt Toplam</td>
    <td width="120" align="right">'.number_format($toplamTutar, 2, ',', '.').' </td>
</tr>';

$htmlAlt .= '<tr style="background-color:#ffffff; font-weight:bold;">
    <td width="140" align="right">KDV</td>
    <td width="120" align="right">'.number_format($toplam_indirimliKdv , 2, ',', '.').' </td>
</tr>';

$htmlAlt .= '<tr style="background-color:#ffffff; font-weight:bold;">
    <td width="140" align="right">Genel Toplam (TL)</td>
    <td width="120" align="right">'.number_format($toplamTutar + $toplam_indirimliKdv , 2, ',', '.').' </td>
</tr>';
